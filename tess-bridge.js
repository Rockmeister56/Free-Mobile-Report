...
class TessBridge {
    ...
    autoFixTess() {
        ...
        const message = `Hi! I'm Tess your Smart AI Guide and I just analyzed your site at ${data.url}, and it looks like your main lead block is in your prequalification form that is costing you approximently ${spokenLoss} dollars per month in PPC waste. Before we get into your audit report, can I get your name please?`;
